#definition of a classical NN for 0-1 MNIST data recognition.
#results used to make comparison
...
X_test.data = X_test.data[idx] #tensor values
X_test.targets = X_test.targets[idx]#tensor labels
...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        return x #returning probabilities in a 2D vector
...
#training and evaluating training time
loss_list = []
...
#RESULTS
#the training took 6.71 seconds to complete
#Performance on test data:
#Loss: 0.40, Accuracy: 100%